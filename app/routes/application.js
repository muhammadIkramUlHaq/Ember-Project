...
export default Ember.Route.extend({
  async model() {
    ...
    return projects.map((project) => {
      let { name, status, id, rate, summary, illustration, amount, grade, onlineDate, expirationDate, openingDate, loanDuration  } = project;
      ...
      return { name, status, id, rate, summary_en, image, grade, amount, expirationDate, loanDuration  };
    });
  },
});
